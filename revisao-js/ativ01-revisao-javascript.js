...
/*let dados = ['nome','sigla','area','populacao',
   'Sergipe','SE',21915.08,2278308,
   'Alagoas','AL',27848.14,3322820,
   'Rio Grande do Norte', 'RN',52811.05,3479010,
   'Paraíba','PB',56469.78,3996496,
...
for(let i = 0; i < estadosNe.length; i++){
    estadosNe[i].densidadeDemografica =  arrow(estadosNe[i].area, estadosNe[i].populacao)
...
let vazio = []
for(let i in estadosNe)[
    vazio.push(estadosNe[i].nome)
]
vazio.sort()
console.log(vazio)
